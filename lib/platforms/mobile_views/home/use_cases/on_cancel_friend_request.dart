...
class OnCancelFriendRequest extends Execute {
  ...
  OnCancelFriendRequest({
    ...
    super.instance = 'OnCancelFriendRequest'
  });
  ...
  execute() async {
    ...
    if(response.statusCode == 200){
      ...
      showSnackBar(
        ...
        message: "You've cancelled your friend request from them.", 
      ...
      showSnackBar(
        ...
        message: 'Failed to cancel friend request. Network issue.', 
        duration: const Duration(milliseconds: 1500)
      );
    }
  }
